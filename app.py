...
# Load model
model = pickle.load(open(r"C:\Users\HP\OneDrive\Desktop\heart disease prediction\Models\rf_classifier.pkl", 'rb'))
scaler = pickle.load(open(r"C:\Users\HP\OneDrive\Desktop\heart disease prediction\Models\scaler.pkl", 'rb'))
